...
ARG RENOVATE_VERSION=23.56.11

# Base image
#============
FROM renovate/buildpack:2@sha256:0e2a006e0e363c2fe1cc9fd733185597174a35a23278d2a1e8eda72b3fe8ad78 AS base
