...
ARG RENOVATE_VERSION=24.9.4

# Base image
#============
FROM renovate/buildpack:2@sha256:bf2d46dde07491e732d2f883b49282fb75b4a14240859b7ba1134c7573962418 AS base
