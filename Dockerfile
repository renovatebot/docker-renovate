...
ARG RENOVATE_VERSION=23.100.3

# Base image
#============
FROM renovate/buildpack:2@sha256:386149aa474a6e0df1f1cea77377a9230d80bb531fced10032acbe3859fe9edd AS base
